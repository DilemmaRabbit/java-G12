...
public class Startforest_s extends BasicGameState {
    ...
    public Startforest_s(int state) {
    }
    ...
    public void update(GameContainer gameContainer, StateBasedGame stateBasedGame, int i) throws SlickException {
        ...
        if(mode==4){
            stateBasedGame.enterState(14,new FadeOutTransition(),new FadeInTransition());
            mode=5;
        }
        if(getdata==1) {
            try {
                ...
                medicine_large = get.getMedicine_large();
                medicine_small = get.getMedicine_small();
                getdata=0;
